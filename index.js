...
let fighting;
let monsterHealth;
let inventory = ["stick"];  /* ["stick" , "dagger" , "sword"];  - In future will use it*/
...
button1.onclick = goStore;  // goStore ,goCave and fightDragons are the functions 
...
function attack(){ 
    ...
    if (health <= 0){
       ...
       fighting === 2 ? winGame() : defeastMonster();  // turner statement , single line if- else virson 
